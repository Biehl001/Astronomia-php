...
if (isset($_GET['excluir'])) {
    ...
    header('Location: ' . BASE_URL . '/pages/minhas-noticias.php');
    exit;
}
...
<div class="container">
    <div class="manage-header">
        ...
        <a href="<?= BASE_URL ?>/pages/noticia-form.php" class="btn btn-primary btn-sm">
        ...
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="<?= BASE_URL ?>/noticia.php?id=<?= $n['id'] ?>" style="color: var(--text-primary); font-weight: 600;">
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?= BASE_URL ?>/pages/noticia-form.php?id=<?= $n['id'] ?>" class="btn btn-secondary btn-sm" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button class="btn btn-danger btn-sm"
                                        data-delete="<?= BASE_URL ?>/pages/minhas-noticias.php?excluir=<?= $n['id'] ?>"
