...
if (isset($_GET['excluir'])) {
    ...
    header('Location: ' . BASE_URL . '/pages/categorias-gerenciar.php');
    exit;
}
            ...
            <div class="sidebar-widget">
                ...
                <form method="POST" action="">
                    ...
                    <div class="btn-group">
                        ...
                        <?php if ($editando): ?>
                            <a href="<?= BASE_URL ?>/pages/categorias-gerenciar.php" class="btn btn-secondary">
                                Cancelar
                            </a>
                        <?php endif; ?>
                    </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-danger btn-sm"
                                                data-delete="<?= BASE_URL ?>/pages/categorias-gerenciar.php?excluir=<?= $cat['id'] ?>"
