...
<div class="container">
    <div class="manage-header">
        ...
        <a href="<?= BASE_URL ?>/pages/minhas-noticias.php" class="btn btn-secondary btn-sm">
    ...
    <div style="max-width: 800px;">
        <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="image-upload">
                    ...
                    <div class="image-preview" style="<?= empty($noticia['imagem']) ? 'display:none' : '' ?>">
                        <?php if (!empty($noticia['imagem'])): ?>
                            <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($noticia['imagem']) ?>" alt="Preview">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="btn-group">
                ...
                <a href="<?= BASE_URL ?>/pages/minhas-noticias.php" class="btn btn-secondary btn-lg">
                    Cancelar
                </a>
            </div>
        </form>
