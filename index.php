...
<div class="container">
    ...
    <a href="<?= BASE_URL ?>/noticia.php?id=<?= $destaque['id'] ?>" style="text-decoration: none; color: inherit;">
        <div class="news-card featured-card">
            <div class="news-card-img">
                <?php if ($destaque['imagem']): ?>
                    <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($destaque['imagem']) ?>"
    ...
    <div class="section-header">
        ...
        <a href="<?= BASE_URL ?>/busca.php" class="section-link">
    ...
    <?php if (empty($recentes) && !$destaque): ?>
        <div class="empty-state">
            ...
            <?php if (isLoggedIn()): ?>
                <a href="<?= BASE_URL ?>/pages/noticia-form.php" class="btn btn-primary">
        ...
        <div class="layout-with-sidebar">
            <div>
                <div class="news-grid" style="grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));">
                    ...
                    <a href="<?= BASE_URL ?>/noticia.php?id=<?= $n['id'] ?>" style="text-decoration: none; color: inherit;">
                        <div class="news-card">
                            <div class="news-card-img">
                                <?php if ($n['imagem']): ?>
                                    <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($n['imagem']) ?>"
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="sidebar-news-item">
                        ...
                        <div>
                            <h4><a href="<?= BASE_URL ?>/noticia.php?id=<?= $p['id'] ?>"><?= htmlspecialchars($p['titulo']) ?></a></h4>
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="category-pills">
                        ...
                        <a href="<?= BASE_URL ?>/categorias.php?id=<?= $c['id'] ?>" class="category-pill">
                ...
                <div class="sidebar-widget" style="background: linear-gradient(135deg, rgba(124,58,237,0.2), rgba(59,130,246,0.2)); border-color: rgba(124,58,237,0.3);">
                    ...
                    <a href="<?= BASE_URL ?>/cadastro.php" class="btn btn-primary btn-block btn-sm">
