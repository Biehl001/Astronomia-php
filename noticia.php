...
<div class="container">
    <div class="news-single">
        <div class="news-single-header">
            <?php if ($noticia['categoria_nome']): ?>
                <a href="<?= BASE_URL ?>/categorias.php?id=<?= $noticia['cat_id'] ?>" class="news-single-category">
        ...
        <div class="news-single-image">
            <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($noticia['imagem']) ?>"
        ...
        <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--border);">
            <div class="btn-group">
                <a href="<?= BASE_URL ?>/pages/noticia-form.php?id=<?= $noticia['id'] ?>" class="btn btn-secondary btn-sm">
                    <i class="fas fa-edit"></i> Editar Notícia
                </a>
                <button class="btn btn-danger btn-sm"
                        data-delete="<?= BASE_URL ?>/pages/minhas-noticias.php?excluir=<?= $noticia['id'] ?>"
    ...
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div class="news-grid" style="grid-template-columns: repeat(auto-fill, minmax(240px, 1fr));">
            ...
            <a href="<?= BASE_URL ?>/noticia.php?id=<?= $r['id'] ?>" style="text-decoration: none; color: inherit;">
                <div class="news-card">
                    <div class="news-card-img" style="height: 150px;">
                        <?php if ($r['imagem']): ?>
                            <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($r['imagem']) ?>"
