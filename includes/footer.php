            ...
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= BASE_URL ?>/busca.php">Buscar</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h4>Categorias</h4>
                    <ul>
                        ...
                        <li>
                            <a href="<?= BASE_URL ?>/categorias.php?id=<?= $cat['id'] ?>">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <?php if (isLoggedIn()): ?>
                            <li><a href="<?= BASE_URL ?>/pages/perfil.php">Meu Perfil</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/minhas-noticias.php">Minhas Notícias</a></li>
                            <li><a href="<?= BASE_URL ?>/pages/noticia-form.php">Nova Notícia</a></li>
                        <?php else: ?>
                            <li><a href="<?= BASE_URL ?>/login.php">Entrar</a></li>
                            <li><a href="<?= BASE_URL ?>/cadastro.php">Cadastrar</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
