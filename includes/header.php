            ...
            <div class="navbar-menu" id="navbarMenu">
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= BASE_URL ?>/categorias.php" class="dropdown-item">
                            <i class="fas fa-th-large"></i> Todas as Categorias
                        </a>
                        <div class="dropdown-divider"></div>
                        <?php foreach ($categoriasMenu as $cat): ?>
                        <a href="<?= BASE_URL ?>/categorias.php?id=<?= $cat['id'] ?>" class="dropdown-item">
                ...
                <a href="<?= BASE_URL ?>/busca.php" class="nav-link">
                ...
                <?php if (isLoggedIn()): ?>
                    <div class="nav-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="<?= BASE_URL ?>/pages/minhas-noticias.php" class="dropdown-item">
                                <i class="fas fa-newspaper"></i> Minhas Notícias
                            </a>
                            <a href="<?= BASE_URL ?>/pages/noticia-form.php" class="dropdown-item">
                                <i class="fas fa-plus-circle"></i> Nova Notícia
                            </a>
                            <a href="<?= BASE_URL ?>/pages/categorias-gerenciar.php" class="dropdown-item">
                                <i class="fas fa-tags"></i> Gerenciar Categorias
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="<?= BASE_URL ?>/pages/perfil.php" class="dropdown-item">
                ...
                <?php else: ?>
                    <a href="<?= BASE_URL ?>/login.php" class="nav-link btn-login">
